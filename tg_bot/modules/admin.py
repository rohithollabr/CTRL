...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    message.reply_text("Successfully promoted {} in *{}*".format(mention_html(member.user.id, member.user.first_name), (chat.title), parse_mode=ParseMode.HTML))
    return (
        "<b>{}:</b>"
        "\n#PROMOTED"
        "\n<b>Admin:</b> {}"
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    try:
        ...
        message.reply_text("Successfully demoted {} in *{}*".format(mention_html(member.user.id, member.user.first_name), (chat.title), parse_mode=ParseMode.HTML))
