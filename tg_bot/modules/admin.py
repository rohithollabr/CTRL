...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    message.reply_text("Successfully promoted {} in *{}*".format(mention_html(user_member.user.id, user_member.user.first_name), (chat.title), parse_mode=ParseMode.MARKDOWN))
    return (
        "<b>{}:</b>"
        "\n#PROMOTED"
        "\n<b>Admin:</b> {}"
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    try:
        ...
        message.reply_text("Successfully demoted {} in *{}*".format(mention_html(user_member.user.id, user_member.user.first_name), (chat.title), parse_mode=ParseMode.MARKDOWN))
